...
/***/ function(module, exports, __webpack_require__) {
	...
	var $, Markdown, app, createClass, createMdElement, md2react, ref, render;

	ref = __webpack_require__(3), createClass = ref.createClass, $ = ref.createElement, render = ref.render;

	md2react = __webpack_require__(4);
	...
	Markdown = createClass({
	  ...
	  componentDidMount: function() {
	    var md;
	    md = document.body.textContent;
	    return console.log('componentDidMount:', md);
	  },
	  update: function(md) {
	...
	(function() {
	  var cache, fetch, idFetch, isLocalFile, onFetched, onReadyStateChange, ref1, url, xhr;
	  url = location.href;
	  isLocalFile = /^file:\/\//i.test(url);
	  if (!isLocalFile) {
	    return;
	  }
	  ref1 = [], idFetch = ref1[0], cache = ref1[1];
	  onReadyStateChange = function() {
	    clearTimeout(idFetch);
	    if (xhr.readyState === 4 && xhr.status !== 404) {
	      onFetched(xhr.responseText);
	      return idFetch = setTimeout(fetch, 1000);
	    }
	  };
	  fetch = function() {
	    xhr.abort();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  mdast = __webpack_require__(9);

	  uuid = __webpack_require__(30);

	  preprocess = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ware = __webpack_require__(103);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var he = __webpack_require__(148);
	var utilities = __webpack_require__(35);
	var defaultExpressions = __webpack_require__(101);
	var defaults = __webpack_require__(102).parse;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var table = __webpack_require__(147);
	var utilities = __webpack_require__(35);
	var defaults = __webpack_require__(102).stringify;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slice = [].slice;
	var wrap = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noop = function(){};
	var co = __webpack_require__(175);
